...
public class BackArrowButton extends JButton {
    ...
    public BackArrowButton(Color[] gradientColors) {
        super();
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Notice we flip the direction of the lines
