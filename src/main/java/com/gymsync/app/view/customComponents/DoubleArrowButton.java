...
public class DoubleArrowButton extends JButton {
	...
	public DoubleArrowButton(Color[] gradientColors) {
		super();
	...
	protected void paintComponent(Graphics g) {
		...
		int half = size / 2;
		int spacing = thickness * 2; // distance between arrows
		...
		// LEFT arrow (front)
		arrowG.drawLine(cx + half / 2 - spacing, cy - half, cx - half / 2 - spacing, cy);
		arrowG.drawLine(cx + half / 2 - spacing, cy + half, cx - half / 2 - spacing, cy);
